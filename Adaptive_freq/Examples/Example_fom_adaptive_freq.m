...
params.bw = 0.6 ; %bandwidth of the bell filter


params.tol = 1e-14; % Tolerance in the truncation step of the Loewner framework
...
if tikzflag == 1
addpath('M2tikz/')
matlab2tikz('Exm_fom_TF.tikz','width','\fwidth','height','\fheight')
end
